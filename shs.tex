...
\begin{figure*}
\centering\includegraphics[width=0.45\linewidth,clip=true]{wideview3k}\quad\quad\includegraphics[width=0.45\linewidth,clip=true]{closeview3k}\\
\vspace{2em}
\includegraphics[width=0.45\linewidth,clip=true]{wideview10k}\quad\quad\includegraphics[width=0.45\linewidth,clip=true]{closeview10k}
